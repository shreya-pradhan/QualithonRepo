...
public class OMDbAPI {
     ...
     **/
    public Movie getMovie(String movieTitle,boolean isImdb) throws UnsupportedEncodingException {
        //call OMDb movie api
        ...
        String rottenPotatoRating=movieMetadata.getJSONArray("Ratings").get(1).toString().split(",")[1].split(":")[1].trim().replace("}", "");
        String actualRating=isImdb?movieMetadata.getString("imdbRating"):rottenPotatoRating.replace('\"',' ').trim();;
        ...
        movie.setMovieRating(actualRating);
