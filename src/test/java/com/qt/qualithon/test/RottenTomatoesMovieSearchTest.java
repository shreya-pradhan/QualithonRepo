...
import com.qt.qualithon.ui.RottenTomatoes.RottenTomatoesMoviePage;
 ...
 **/
public class RottenTomatoesMovieSearchTest {
    ...
    public void testSearchByExactMovieTitleReturnsMovieAsFirstResult(String title){
        ...
        RottenTomatoesMoviePage  movieRottenTomatoesWeb = new RottenTomatoesWebApp(this.testSession)
            .launch()
            .search(title)                                                                                                                                                                                                                                                                                              
            .firstMovieResult();

        assertThat(movieRottenTomatoesWeb.title().toLowerCase()).isEqualTo(title.toLowerCase());
    }
    ...
    public void testMovieMetadataOnWebHasCorrectReleaseYear(String title) throws Exception {
        ...
        RottenTomatoesMoviePage movieRottenTomatoesWeb = new RottenTomatoesWebApp(this.testSession)
            .launch()
            .search(title).firstMovieResult();

        // get Movie metadata from http://www.omdbapi.com/
        Movie movie = new OMDbAPI().getMovie(title,false);
        assertThat(movieRottenTomatoesWeb.releaseYear().trim()).isEqualTo(movie.releaseYear().trim());
    }
    ...
    public void testMovieMetadataOnWebHasCorrectDirectorName(String title) throws Exception {
        ...
        // get Movie metadata from http://www.omdbapi.com/
        Movie movie = new OMDbAPI().getMovie(title,false);
        assertThat(movieRottenTomatoesWeb.director()).isEqualTo(movie.director());
    }
    ...
    public void testMovieMetadataOnWebHasCorrectWriters(String title) throws Exception {
        ...
        // get Movie metadata from http://www.omdbapi.com/
        Movie movie = new OMDbAPI().getMovie(title,false);
        assertThat(movieRottenTomatoesWeb.writers()).hasSameElementsAs(movie.writers());
    }
    ...
    public void testMovieMetadataOnWebHasCorrectGenres(String title) throws Exception {
        ...
        // get Movie metadata from http://www.omdbapi.com/
        Movie movie = new OMDbAPI().getMovie(title,false);
        assertThat(movieRottenTomatoesWeb.genres()).hasSameElementsAs(movie.genres());
    }
    ...
    // get Movie metadata from http://www.omdbapi.com/
    Movie movie = new OMDbAPI().getMovie(title,false);
    assertThat(movieRottenTomatoesWeb.maturityRating()).isEqualTo(movie.maturityRating());
    }
    ...
    // get Movie metadata from http://www.omdbapi.com/
    Movie movie = new OMDbAPI().getMovie(title,false);
    assertThat(movieRottenTomatoesWeb.movieRating()).isEqualTo(movie.movieRating());
    }
}
